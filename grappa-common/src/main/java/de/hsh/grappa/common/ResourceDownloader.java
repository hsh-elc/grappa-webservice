...
public class ResourceDownloader {
    ...
    private MimeType getMimeType(String contentType) throws GrappaException, MalformedURLException, IOException {
    ...
    public Resource downloadResource(String url) throws MalformedURLException, IOException {
