...
- run login with default-pw and set new ... I chose: bitnami & `moodle-moopt`
...
- goto IP and login into Moodle ... Better the way with the Host-only network
...
If installation hangs on "curtin hooks"-spinning wheel, but it says "Installation complete!" at the top, you can go on,
...
* site administration -> Users -> Permissions -> Capability overview -> search for trustcontent -> select the capability
  “moodle/site:trustcontent” and choose “Get the overview”. Check, that teachers have the permission.
