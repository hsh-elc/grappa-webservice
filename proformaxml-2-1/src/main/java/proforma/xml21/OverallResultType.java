...
/**
 * <p>Java class for overall-result-type complex type.
 *
 ...
 *       &lt;sequence>
 *         &lt;element name="score" type="{urn:proforma:v2.1}overall-score-type"/>
...
@XmlType(name = "overall-result-type", namespace = "urn:proforma:v2.1", propOrder = {
    "score",
    "validity"
})
