...
public class ObjectFactory {
    ...
    private final static QName _Task_QNAME = new QName("urn:proforma:v2.1", "task");
    private final static QName _Response_QNAME = new QName("urn:proforma:v2.1", "response");
    private final static QName _Submission_QNAME = new QName("urn:proforma:v2.1", "submission");
    private final static QName _FeedbackListTypeTeacherFeedback_QNAME = new QName("urn:proforma:v2.1", "teacher-feedback");
    private final static QName _FeedbackListTypeStudentFeedback_QNAME = new QName("urn:proforma:v2.1", "student-feedback");
    ...
    public JAXBElement<FeedbackType> createFeedbackListTypeTeacherFeedback(FeedbackType value) {
        return new JAXBElement<FeedbackType>(_FeedbackListTypeTeacherFeedback_QNAME, FeedbackType.class, FeedbackListType.class, value);
    }
    ...
    public JAXBElement<FeedbackType> createFeedbackListTypeStudentFeedback(FeedbackType value) {
        return new JAXBElement<FeedbackType>(_FeedbackListTypeStudentFeedback_QNAME, FeedbackType.class, FeedbackListType.class, value);
    }
