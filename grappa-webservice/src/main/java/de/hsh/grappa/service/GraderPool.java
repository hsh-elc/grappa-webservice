...
//        new ConcurrentHashMap<>();
    ...
    public ProformaResponse runGradingProcess(QueuedSubmission subm) {
        try {
            ...
            try {
                ...
                ProformaResponse resp = futureTask.get(timeoutSeconds, TimeUnit.SECONDS);
                ...
                return ProformaV201ResponseGenerator.createInternalErrorResponse(errorMessage);
                ...
                return ProformaV201ResponseGenerator.createInternalErrorResponse(String.format("Grader '%s' timed out " +
    ...
    private BackendPlugin loadBackendPlugin(GraderConfig grader) throws Exception {
        log.info("Loading and initializing grader '{}' from file '{}'...",
