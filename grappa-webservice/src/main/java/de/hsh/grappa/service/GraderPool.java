...
public class GraderPool {
    ...
    private BackendPlugin loadAndInitBackendPlugin(String submId) throws Exception {
        ...
        if (operatingMode.equals(OP_MODE_DOCKER_VM)) {
            ...
            String runContainerInDockerNetwork = dockerBPConfig.getRun_container_in_docker_network();
            ...
            //set prefs
            dockerBp.setDockerPrefs(dockerHost, imageName, runContainerInDockerNetwork, copySubmissionToDirPath, loadResponseFromDirPath, copyGraderPluginDefaultsPropertiesToFile);
