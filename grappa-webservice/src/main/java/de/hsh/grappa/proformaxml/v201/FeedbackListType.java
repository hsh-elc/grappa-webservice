...
/**
 * <p>Java-Klasse f�r feedback-list-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="student-feedback" type="{urn:proforma:v2.0.1}feedback-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="teacher-feedback" type="{urn:proforma:v2.0.1}feedback-type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "feedback-list-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "studentFeedback",
    "teacherFeedback"
})
