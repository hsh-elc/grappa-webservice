...
/**
 * <p>Java-Klasse f�r lms-type complex type.
 * 
...
@XmlType(name = "lms-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "submissionDatetime",
    "userId",
    "courseId",
    "any"
...
public class LmsType {
    ...
    @XmlElement(name = "submission-datetime", namespace = "urn:proforma:v2.0.1", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar submissionDatetime;
    @XmlElement(name = "user-id", namespace = "urn:proforma:v2.0.1")
    protected List<String> userId;
    @XmlElement(name = "course-id", namespace = "urn:proforma:v2.0.1")
