 ...
 *       
 * 
 * <p>Java-Klasse f�r grading-hints-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="root" type="{urn:proforma:v3.0.0}grades-node-type"/>
 *         &lt;element name="combine" type="{urn:proforma:v3.0.0}grades-node-type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "grading-hints-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "root",
    "combine",
    "any"
})
