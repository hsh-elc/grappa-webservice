 ...
 *       &lt;sequence>
 *         &lt;element name="grader-engine" type="{urn:proforma:v3.0.0}grader-engine-type"/>
...
@XmlType(name = "response-meta-data-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "graderEngine",
    "any"
})
public class ResponseMetaDataType {

    @XmlElement(name = "grader-engine", namespace = "urn:proforma:v3.0.0", required = true)
