 ...
 *           &lt;element name="test-ref" type="{urn:proforma:v2.0.1}grades-test-ref-child-type"/>
 *           &lt;element name="combine-ref" type="{urn:proforma:v2.0.1}grades-combine-ref-child-type"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "grades-node-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "title",
    "description",
    "internalDescription",
    "testRefOrCombineRef"
...
public class GradesNodeType {
    ...
    @XmlElements({
        @XmlElement(name = "test-ref", namespace = "urn:proforma:v2.0.1", type = GradesTestRefChildType.class),
        @XmlElement(name = "combine-ref", namespace = "urn:proforma:v2.0.1", type = GradesCombineRefChildType.class)
    })
