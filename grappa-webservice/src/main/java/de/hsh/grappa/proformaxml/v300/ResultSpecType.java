 ...
 *       &lt;sequence>
 *         &lt;element name="student-feedback-level" type="{urn:proforma:v3.0.0}feedback-level-type" minOccurs="0"/>
 *         &lt;element name="teacher-feedback-level" type="{urn:proforma:v3.0.0}feedback-level-type" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "result-spec-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "studentFeedbackLevel",
    "teacherFeedbackLevel"
})
public class ResultSpecType {

    @XmlElement(name = "student-feedback-level", namespace = "urn:proforma:v3.0.0")
    @XmlSchemaType(name = "string")
    protected FeedbackLevelType studentFeedbackLevel;
    @XmlElement(name = "teacher-feedback-level", namespace = "urn:proforma:v3.0.0")
    @XmlSchemaType(name = "string")
