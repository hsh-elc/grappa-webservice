 ...
 *       &lt;sequence>
 *         &lt;element name="subtest-response" type="{urn:proforma:v3.0.0}subtest-response-type" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "subtests-response-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "subtestResponse"
})
public class SubtestsResponseType {

    @XmlElement(name = "subtest-response", namespace = "urn:proforma:v3.0.0", required = true)
