...
/**
 * <p>Java-Klasse f�r merged-test-feedback-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="overall-result" type="{urn:proforma:v2.0.1}overall-result-type"/>
 *         &lt;element name="student-feedback" type="{urn:proforma:v2.0.1}merged-feedback-type" minOccurs="0"/>
 *         &lt;element name="teacher-feedback" type="{urn:proforma:v2.0.1}merged-feedback-type" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "merged-test-feedback-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "overallResult",
    "studentFeedback",
    "teacherFeedback"
})
public class MergedTestFeedbackType {
    ...
    @XmlElement(name = "overall-result", namespace = "urn:proforma:v2.0.1", required = true)
    protected OverallResultType overallResult;
    @XmlElement(name = "student-feedback", namespace = "urn:proforma:v2.0.1")
    protected String studentFeedback;
    @XmlElement(name = "teacher-feedback", namespace = "urn:proforma:v2.0.1")
