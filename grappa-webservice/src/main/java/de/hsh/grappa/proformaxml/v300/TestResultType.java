...
/**
 * <p>Java-Klasse für test-result-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="result" type="{urn:proforma:v3.0.0}result-type"/>
 *         &lt;element name="feedback-list" type="{urn:proforma:v3.0.0}feedback-list-type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "test-result-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "result",
    "feedbackList"
})
public class TestResultType {
    ...
    @XmlElement(name = "feedback-list", namespace = "urn:proforma:v3.0.0", required = true)
