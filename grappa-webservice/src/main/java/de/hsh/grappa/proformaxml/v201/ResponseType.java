 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="merged-test-feedback" type="{urn:proforma:v2.0.1}merged-test-feedback-type"/>
 *           &lt;element name="separate-test-feedback" type="{urn:proforma:v2.0.1}separate-test-feedback-type"/>
 *         &lt;/choice>
 *         &lt;element name="files" type="{urn:proforma:v2.0.1}response-files-type"/>
 *         &lt;element name="response-meta-data" type="{urn:proforma:v2.0.1}response-meta-data-type"/>
 *       &lt;/sequence>
...
public class ResponseType {
    ...
    @XmlElement(name = "merged-test-feedback", namespace = "urn:proforma:v2.0.1")
    protected MergedTestFeedbackType mergedTestFeedback;
    @XmlElement(name = "separate-test-feedback", namespace = "urn:proforma:v2.0.1")
    ...
    @XmlElement(name = "response-meta-data", namespace = "urn:proforma:v2.0.1", required = true)
