 ...
 *       &lt;sequence>
 *         &lt;element name="root" type="{urn:proforma:v2.0.1}grades-node-type"/>
 *         &lt;element name="combine" type="{urn:proforma:v2.0.1}grades-node-type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "grading-hints-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "root",
    "combine",
    "any"
})
