...
/**
 * <p>Java-Klasse f�r separate-test-feedback-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="submission-feedback-list" type="{urn:proforma:v2.0.1}feedback-list-type"/>
 *         &lt;element name="tests-response" type="{urn:proforma:v2.0.1}tests-response-type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "separate-test-feedback-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "submissionFeedbackList",
    "testsResponse"
})
public class SeparateTestFeedbackType {

    @XmlElement(name = "submission-feedback-list", namespace = "urn:proforma:v2.0.1", required = true)
    protected FeedbackListType submissionFeedbackList;
    @XmlElement(name = "tests-response", namespace = "urn:proforma:v2.0.1", required = true)
