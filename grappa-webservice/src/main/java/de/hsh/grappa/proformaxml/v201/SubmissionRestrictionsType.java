 ...
 *         &lt;element name="file-restriction" type="{urn:proforma:v2.0.1}file-restr-type"/>
 *       &lt;/sequence>
...
@XmlType(name = "submission-restrictions-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "fileRestriction"
})
public class SubmissionRestrictionsType {

    @XmlElement(name = "file-restriction", namespace = "urn:proforma:v2.0.1")
