...
/**
 * <p>Java-Klasse f�r tests-response-type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="test-response" type="{urn:proforma:v2.0.1}test-response-type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "tests-response-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "testResponse"
})
public class TestsResponseType {

    @XmlElement(name = "test-response", namespace = "urn:proforma:v2.0.1")
