 ...
 *       
 * 
 * <p>Java-Klasse f�r grades-nullify-conditions-type complex type.
 * 
 ...
 *           &lt;element name="nullify-conditions" type="{urn:proforma:v2.0.1}grades-nullify-conditions-type"/>
 *           &lt;element name="nullify-condition" type="{urn:proforma:v2.0.1}grades-nullify-condition-type"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "grades-nullify-conditions-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    ...
    extends GradesNullifyBaseType
{
    ...
    @XmlElements({
        @XmlElement(name = "nullify-conditions", namespace = "urn:proforma:v2.0.1", type = GradesNullifyConditionsType.class),
        @XmlElement(name = "nullify-condition", namespace = "urn:proforma:v2.0.1", type = GradesNullifyConditionType.class)
    })
