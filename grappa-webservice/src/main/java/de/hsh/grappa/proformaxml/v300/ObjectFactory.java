 ...
 * generated in the de.hsh.grappa.proformaxml.v300 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Response_QNAME = new QName("urn:proforma:v3.0.0", "response");
    private final static QName _Task_QNAME = new QName("urn:proforma:v3.0.0", "task");
    private final static QName _Submission_QNAME = new QName("urn:proforma:v3.0.0", "submission");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.hsh.grappa.proformaxml.v300
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v3.0.0", name = "response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v3.0.0", name = "task")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v3.0.0", name = "submission")
