 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="external-task" type="{urn:proforma:v3.0.0}external-task-type"/>
 *           &lt;element name="included-task-file" type="{urn:proforma:v3.0.0}included-task-file-type"/>
 *           &lt;element name="task" type="{urn:proforma:v3.0.0}task-type"/>
 *         &lt;/choice>
 *         &lt;element name="grading-hints" type="{urn:proforma:v3.0.0}grading-hints-type" minOccurs="0"/>
 *         &lt;choice>
 *           &lt;element name="external-submission" type="{urn:proforma:v3.0.0}external-submission-type"/>
 *           &lt;element name="files" type="{urn:proforma:v3.0.0}submission-files-type"/>
 *         &lt;/choice>
 *         &lt;element name="lms" type="{urn:proforma:v3.0.0}lms-type" minOccurs="0"/>
 *         &lt;element name="result-spec" type="{urn:proforma:v3.0.0}result-spec-type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "submission-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "externalTask",
    "includedTaskFile",
    "task",
    "gradingHints",
...
public class SubmissionType implements AbstractSubmissionType {
    ...
    @XmlElement(name = "external-task", namespace = "urn:proforma:v3.0.0")
    protected ExternalTaskType externalTask;
    @XmlElement(name = "included-task-file", namespace = "urn:proforma:v3.0.0")
    ...
    @XmlElement(name = "external-submission", namespace = "urn:proforma:v3.0.0")
    protected String externalSubmission;
    @XmlElement(namespace = "urn:proforma:v3.0.0")
    protected SubmissionFilesType files;
    @XmlElement(namespace = "urn:proforma:v3.0.0")
    protected LmsType lms;
    @XmlElement(name = "result-spec", namespace = "urn:proforma:v3.0.0", required = true)
