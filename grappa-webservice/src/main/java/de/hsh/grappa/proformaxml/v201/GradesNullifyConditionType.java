 ...
 *   &lt;complexContent>
 *     &lt;extension base="{urn:proforma:v2.0.1}grades-nullify-base-type">
 *       &lt;sequence>
 *         &lt;choice maxOccurs="2" minOccurs="2">
 *           &lt;element name="nullify-combine-ref" type="{urn:proforma:v2.0.1}grades-nullify-combine-ref-type"/>
 *           &lt;element name="nullify-test-ref" type="{urn:proforma:v2.0.1}grades-nullify-test-ref-type"/>
 *           &lt;element name="nullify-literal" type="{urn:proforma:v2.0.1}grades-nullify-literal-type"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "grades-nullify-condition-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    ...
    extends GradesNullifyBaseType
{
    ...
    @XmlElements({
        @XmlElement(name = "nullify-combine-ref", namespace = "urn:proforma:v2.0.1", type = GradesNullifyCombineRefType.class),
        @XmlElement(name = "nullify-test-ref", namespace = "urn:proforma:v2.0.1", type = GradesNullifyTestRefType.class),
        @XmlElement(name = "nullify-literal", namespace = "urn:proforma:v2.0.1", type = GradesNullifyLiteralType.class)
    })
