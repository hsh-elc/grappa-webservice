...
@XmlType(name = "grades-base-ref-child-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "nullifyConditions",
    "nullifyCondition"
})
@XmlSeeAlso({
...
public class GradesBaseRefChildType {
    ...
    @XmlElement(name = "nullify-conditions", namespace = "urn:proforma:v2.0.1")
    protected GradesNullifyConditionsType nullifyConditions;
    @XmlElement(name = "nullify-condition", namespace = "urn:proforma:v2.0.1")
