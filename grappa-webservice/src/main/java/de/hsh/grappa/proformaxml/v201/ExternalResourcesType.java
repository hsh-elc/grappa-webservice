 ...
 *         &lt;element name="external-resource" type="{urn:proforma:v2.0.1}external-resource-type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "external-resources-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "externalResource"
})
public class ExternalResourcesType {

    @XmlElement(name = "external-resource", namespace = "urn:proforma:v2.0.1")
