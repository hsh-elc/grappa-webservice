 ...
 *       &lt;choice>
 *         &lt;element name="embedded-zip-file" type="{urn:proforma:v2.0.1}embedded-bin-file-type"/>
 *         &lt;element name="attached-zip-file" type="{urn:proforma:v2.0.1}attached-bin-file-type"/>
 *         &lt;element name="attached-xml-file" type="{urn:proforma:v2.0.1}attached-txt-file-type"/>
 *       &lt;/choice>
...
@XmlType(name = "included-task-file-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "embeddedZipFile",
    "attachedZipFile",
    "attachedXmlFile"
})
public class IncludedTaskFileType {
    ...
    @XmlElement(name = "embedded-zip-file", namespace = "urn:proforma:v2.0.1")
    protected EmbeddedBinFileType embeddedZipFile;
    @XmlElement(name = "attached-zip-file", namespace = "urn:proforma:v2.0.1")
    protected String attachedZipFile;
    @XmlElement(name = "attached-xml-file", namespace = "urn:proforma:v2.0.1")
