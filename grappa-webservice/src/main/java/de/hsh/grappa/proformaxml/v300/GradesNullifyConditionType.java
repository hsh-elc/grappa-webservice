 ...
 *       
 * 
 * <p>Java-Klasse f�r grades-nullify-condition-type complex type.
 * 
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{urn:proforma:v3.0.0}grades-nullify-base-type">
 *       &lt;sequence>
 *         &lt;choice maxOccurs="2" minOccurs="2">
 *           &lt;element name="nullify-combine-ref" type="{urn:proforma:v3.0.0}grades-nullify-combine-ref-type"/>
 *           &lt;element name="nullify-test-ref" type="{urn:proforma:v3.0.0}grades-nullify-test-ref-type"/>
 *           &lt;element name="nullify-literal" type="{urn:proforma:v3.0.0}grades-nullify-literal-type"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "grades-nullify-condition-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    ...
    extends GradesNullifyBaseType
{
    ...
    @XmlElements({
        @XmlElement(name = "nullify-combine-ref", namespace = "urn:proforma:v3.0.0", type = GradesNullifyCombineRefType.class),
        @XmlElement(name = "nullify-test-ref", namespace = "urn:proforma:v3.0.0", type = GradesNullifyTestRefType.class),
        @XmlElement(name = "nullify-literal", namespace = "urn:proforma:v3.0.0", type = GradesNullifyLiteralType.class)
    })
