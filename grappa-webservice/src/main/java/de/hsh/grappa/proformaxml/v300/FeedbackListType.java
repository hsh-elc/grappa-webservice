 ...
 *       &lt;sequence>
 *         &lt;element name="student-feedback" type="{urn:proforma:v3.0.0}feedback-type" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="teacher-feedback" type="{urn:proforma:v3.0.0}feedback-type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "feedback-list-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "studentFeedback",
    "teacherFeedback"
})
