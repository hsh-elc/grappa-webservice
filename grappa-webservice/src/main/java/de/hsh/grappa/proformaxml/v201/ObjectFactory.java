 ...
 * generated in the de.hsh.grappa.proformaxml package.
...
public class ObjectFactory {
    ...
    private final static QName _Response_QNAME = new QName("urn:proforma:v2.0.1", "response");
    private final static QName _Task_QNAME = new QName("urn:proforma:v2.0.1", "task");
    private final static QName _Submission_QNAME = new QName("urn:proforma:v2.0.1", "submission");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.hsh.grappa.proformaxml
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v2.0.1", name = "response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v2.0.1", name = "task")
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:proforma:v2.0.1", name = "submission")
