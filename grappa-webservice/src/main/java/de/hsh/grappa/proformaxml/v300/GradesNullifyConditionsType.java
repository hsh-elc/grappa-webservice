...
@XmlType(name = "grades-nullify-conditions-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    ...
    extends GradesNullifyBaseType
{
    ...
    @XmlElements({
        @XmlElement(name = "nullify-conditions", namespace = "urn:proforma:v3.0.0", type = GradesNullifyConditionsType.class),
        @XmlElement(name = "nullify-condition", namespace = "urn:proforma:v3.0.0", type = GradesNullifyConditionType.class)
    })
