 ...
 *       &lt;sequence>
 *         &lt;element name="test-response" type="{urn:proforma:v3.0.0}test-response-type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "tests-response-type", namespace = "urn:proforma:v3.0.0", propOrder = {
    "testResponse"
})
public class TestsResponseType {

    @XmlElement(name = "test-response", namespace = "urn:proforma:v3.0.0")
