 ...
 *         &lt;element name="model-solution" type="{urn:proforma:v2.0.1}model-solution-type"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "model-solutions-type", namespace = "urn:proforma:v2.0.1", propOrder = {
    "modelSolution"
})
public class ModelSolutionsType {

    @XmlElement(name = "model-solution", namespace = "urn:proforma:v2.0.1", required = true)
